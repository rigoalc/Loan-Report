...
' THE CALSSROOM POINT OF VIEW IS:
' PRCTICE THE UNDERSTANDING OF IPO PROCESESS.
' PRACTICE THE DISIGN OF HIERARCHY AND FLOWCARTS, MOVE THE WRITE HEADINGS AND 
' FOLLOW THE STRUCTURE OF THE CODE AND THE FLOWCHART.
...
' IN THIS ASSIGNMENT WE APPLY NEW CONCEPS LIKE PAGINATION, 
' HOW TO OUTPUT 15 DETAIL LINES PER PAGE, AND ROUNDING WITH (MATH.ROUND) COMMAND.
